...
class plgsystemWhatsappags extends JPlugin {
	...
	function onBeforeRender(){
	   ...
	   if ($popup==1 ) {
		...
		// add style
		$doc->addStyleSheet('plugins/system/whatsappags/assets/floating-wpp.min.css');
		// add script
		$doc->addScript('plugins/system/whatsappags/assets/floating-wpp.min.js');
		// jquery
